...
const Surah = () => {
  ...
  return (
    <Main>
      <div id="_surah" className="container mx-auto bg-white min-h-screen">
              ...
              {ayat.slice(0, renderedAyatCount).map((a, i) => (
                <div className="py-6 border-b flex-column gap-4 items-start justify-between transition-all ease duration-300" key={a.number.inSurah}>
                  <div className="flex gap-3 items-center justify-between">
                    <span className="flex justify-center items-center text-slate-500 text-sm w-10 h-10 rounded-full border">
                      {a.number.inSurah}
                    </span>
